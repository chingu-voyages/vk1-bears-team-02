	...
	return (
		<main className="page-container about-page">
			...
			<div className="aboutCardContainer">
				...
				<Card
					card={{
						...
						imgLink:
							"https://avatars1.githubusercontent.com/u/22428456?s=400&u=15536d051634d203fc805c969cbdf31064787bad&v=4",
						linkedIn:
							"https://www.linkedin.com/in/ivan-christian-jay-funcion-17078114a/",
						github: "https://github.com/supremeking23",
					}}
				/>
				<Card
					card={{
			...
			<div
				...
				<h2>About E-Sagip</h2>
				<p>
					E-Sagip is a real-time, disaster emergency response application that
					aims to enable faster, and more efficient calamity reporting and
					government aid.
				</p>
			</div>
		</main>
